...
*/}}
{{- define "tekton-operator.namespace" -}}
...
{{ include "tekton-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/component: operator
app.kubernetes.io/part-of: {{ include "tekton-operator.name" . }}
...
Selector labels
*/}}
{{- define "tekton-operator.selectorLabels" -}}
...
{{- default (include "tekton-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
